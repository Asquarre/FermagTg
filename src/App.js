...
const App = () => {
  ...
  const [allProducts] = useState({
    ...
    'П/ф замороженная продукция❄️': [
      ...
      { id: 105, name: 'Булочка ачма с шоколадом 100г', price: 18 },
      { id: 106, name: 'булочка с корицей 100г', price: 18 },
      { id: 107, name: 'Элеш с курицей', price: 18 },
      { id: 108, name: 'Плетенка с творогом изюмом', price: 18 },
      { id: 109, name: 'Булочка с маком', price: 18 },
      { id: 110, name: 'Учпучмак с мясом', price: 18 },
      { id: 111, name: 'Булочка ярославская 100г', price: 18 },
      { id: 112, name: 'Вареники отварные с картофелем кг', price: 18 },
      { id: 113, name: 'Вареники отварные с творогом кг', price: 18 },
      { id: 114, name: 'Булочка ачма с творогом и шпинатом', price: 18 },
      { id: 115, name: 'Плетенка со сгущенкой', price: 18 },
      { id: 116, name: 'Плетенка с маком', price: 18 },
      { id: 117, name: 'Сосиска по-баварски', price: 18 },
      { id: 118, name: 'Мини-пицца 130г', price: 18 },
      { id: 119, name: 'Лепешка с сыром 130г', price: 18 },
      { id: 120, name: 'Калач смит турецкий', price: 18 },
      { id: 121, name: 'Булочка поача с сыром 100г', price: 18 },

      { id: 122, name: 'Булочка поача с картошкой 100г', price: 18 },
      { id: 123, name: 'Пирожки печеные с яйцом-луком 100г', price: 18 },
      { id: 124, name: 'Пирожки печеные с картошкой 100г', price: 18 },
      { id: 125, name: 'Пирожки печеные с капустой 100г', price: 18 },
      { id: 126, name: 'Пирог с курицей и картошкой кг', price: 18 },
      { id: 127, name: 'Пирог с мясом и картошкой кг', price: 18 },
      { id: 128, name: 'Плачинада с курицей 150г', price: 18 },
      { id: 129, name: 'Плачинада с мясом 150г', price: 18 },
      { id: 130, name: 'Плюшка с яблоком 120г', price: 18 },
      { id: 131, name: 'Самса с тыквой', price: 18 },
      { id: 132, name: 'Самса с картофелем', price: 18 },
      { id: 133, name: 'Самса большая с курицей', price: 18 },
      { id: 134, name: 'Самса большая с мясом', price: 18 },
      { id: 135, name: 'Самса большая с сыром', price: 18 },
      { id: 136, name: 'Самса Микс', price: 18 },
      { id: 137, name: 'Самса уйгурская с мясом', price: 18 },
      { id: 138, name: 'Самса шашлык филе', price: 184 },
      { id: 139, name: 'Слойка с сыром 100г', price: 183 },
      { id: 140, name: 'Слойка с яблоком 120г', price: 181 },
      { id: 141, name: 'Тесто для баурсаков кг', price: 1810 },
      { id: 142, name: 'Тесто слоеное классическое кг', price: 1812 },
    ],
