...
const App = () => {
  ...
  const [allProducts] = useState({
    ...
    'Кулинария🍴': [
      ...
      { id: 2204, name: 'Салат крабик кг', price: 1.8 },
      { id: 2205, name: 'Салат летний кг', price: 1.8 },
      { id: 2206, name: 'Салат морковь по корейски кг', price: 1.2 },
      { id: 2207, name: 'Салат оливье кг', price: 2.0 },
      { id: 2208, name: 'Салат сельдь под шубой кг', price: 1.8 },
      { id: 2209, name: 'Салат цезарь кг', price: 1.8 },
